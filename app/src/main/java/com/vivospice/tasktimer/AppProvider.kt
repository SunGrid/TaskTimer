...
const val CONTENT_AUTHORITY = "com.vivospice.tasktimer.provider"
...
class AppProvider : ContentProvider(){
    ...
    private fun buildUriMatcher() : UriMatcher {
        ...
        //e.g. content://com.vivospice.tasktimer.provider/Tasks
...
/*
    ...
    override fun insert(uri: Uri, values: ContentValues?): Uri? {
        ...
        when(match) {
            ...
            TASKS -> { // having to use context!! for time being.
            ...
            TIMINGS -> { // having to use context!! for time being.
                val db = AppDatabase.getInstance(context!!).writableDatabase
